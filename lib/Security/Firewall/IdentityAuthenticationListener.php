<?php
namespace ZealByte\Identity\Security\Firewall
{
	...
	/**
	 */
	class IdentityAuthenticationListener extends AbstractAuthenticationListener
	{
		...
		protected function attemptAuthentication(Request $request)
		{
			...
			return $this->authenticationManager->authenticate(new IdentityToken($username, $password, $this->providerKey));
		}
	}
}
